...
public class PodCastCatalogBuilderES extends PodCastCatalogBuilderBase {
    ...
    void addCategoryNames(CategoryContext categoryContext) {
        ...
        categoryContext.add( PodCastIdCollector.Category.NEWS_POLITICS, "Noticias y política");
        ...
        categoryContext.add( PodCastIdCollector.Category.HEALTH, "Salud");
        ...
        categoryContext.add( PodCastIdCollector.Category.K_12, "Formación");
        categoryContext.add( PodCastIdCollector.Category.GAMES_HOBBIES, "Juegos y hobby");
        categoryContext.add( PodCastIdCollector.Category.GOVERNMENT_ORGANIZATIONS, "Autoridades y organizaciones");
        ...
        categoryContext.add( PodCastIdCollector.Category.SCIENCE_MEDICINE, "Ciencia y Medicina");
        categoryContext.add( PodCastIdCollector.Category.SOCIETY_CULTURE, "Sociedad y cultura");
        categoryContext.add( PodCastIdCollector.Category.SPORTS_RECREATION, "Deportes y ocio");
