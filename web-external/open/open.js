        ...
        success: function(data){
            ...
            $.each(data.results,function(i,result){
                ...
                $results[0].insertAdjacentHTML('beforeend','<br><br><a class="result" href="'+link+'" target="_blank"><br><br><img height="580px" width="580px" src="'+hires+'" onerror="src='+result.artworkUrl600+'" /> ' +
                    ...
                    '<p style="color: white;font-size:75px;font-weight: 600"><br>' + podCastName + '</p><p><button onclick="window.location.href = link" class="button button4">   Open in Pods   </button></p>');
            });
        },
        error: function(e){
            console.log(e);
